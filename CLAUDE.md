...
- Bot file: ~/zalo-bot/bot.mjs (zca-js, chạy local)
- Chiều 1: @bot <lệnh> trên Zalo → claude -p xử lý trên repo này
- Chiều 2: INSERT phieu_dat_hang → Supabase Realtime → bot gửi Zalo group
- Bảng ncc_zalo_group: mapping ncc_id ↔ zalo_group_id
- Group mặc định: 2225045345975894137
- Bot dùng service_role key, Realtime đã bật cho phieu_dat_hang
- Không cần sửa code tạo đơn hàng — Realtime tự bắt event
